...
const Wallet = ({ user }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-1 sm:py-2 lg:py-4 px-1 sm:px-2 lg:px-4 mt-16 sm:mt-0">
      ...
      <div className="bg-white rounded-lg shadow p-2 sm:p-3 lg:p-4 mb-3 sm:mb-4 lg:mb-6 flex flex-col items-center w-full">
        ...
        {loading ? (
          ...
          <span className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-700 mb-2 sm:mb-3">${(balance || 0).toLocaleString()}</span>
        )}
        ...
        {/* Messages */}
        {error && (
          <div className="text-red-600 mt-2 sm:mt-3 text-xs sm:text-sm text-center">
            <div>{error}</div>
            <button 
              onClick={fetchWallet}
