...
const navItems = [
  ...
  const TopNavbar = () => (
    <nav className="bg-white border-b border-slate-200 px-4 py-3 shadow-sm overflow-hidden sticky top-0 z-[9998]">
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <button className="fixed top-20 left-4 z-[99999] md:hidden bg-white border border-slate-200 p-2 rounded-full shadow-xl text-slate-700 hover:bg-slate-100 transition-colors" onClick={() => setSidebarOpen(true)}>
